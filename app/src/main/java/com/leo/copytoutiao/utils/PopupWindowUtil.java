...
import com.leo.copytoutiao.view.SanJiaoView;
...
public class PopupWindowUtil {
    ...
    public static PopupWindow showPopupWindow(Context context, View view, View anchor,int location,View.OnClickListener itemsOnClick) {
        ...
        ImageView mImaH4 = (ImageView) view.findViewById(R.id.img_h4);
        ImageView mImaH5 = (ImageView) view.findViewById(R.id.img_h5);
        ImageView mImaH6 = (ImageView) view.findViewById(R.id.img_h6);
        ...
        if (mImaH1 != null) {
            ...
            mImaH4.setOnClickListener(itemsOnClick);
            mImaH5.setOnClickListener(itemsOnClick);
            mImaH6.setOnClickListener(itemsOnClick);
        }
        if (mLyWhite != null) {
